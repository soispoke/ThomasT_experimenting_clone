CREATE OR REPLACE VIEW address_type_exchanges AS
...
SELECT
 ...
 CASE 
 WHEN from IN ('0xfe9e8709d3215310075d67e3ed32a380ccf451c8',
                 ...
                 '0xa910f92acdaf488fa6ef02174fb86208ad7722ba') THEN 'Exchange' END as name,
